...
@SessionAttributes({ "id", "role", "rscode", "nick" })
public class UsersController {
	...
	public String register(UsersVO usersVO) {
	...
	public String updatePassword(RedirectAttributes rttr, @RequestParam("password") String password, @RequestParam("id") String id) {
